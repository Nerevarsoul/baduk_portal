# Generated by Django 2.2.5 on 2019-09-16 09:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('kind', models.CharField(choices=[('tsumego', 'задачи'), ('league', 'лига'), ('theory', 'теория'), ('handicap league', 'форовая лига'), ('special', 'специальное'), ('OGS', 'ОГС')], max_length=20, verbose_name='Тип')),
